...
export const services: Service[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Rotor and drum inspection/resurfacing",
      "Brake line inspection",
    ],
    image:
      "https://via.placeholder.com/600x400.png/28a745/ffffff?text=Brake+Service",
  },
  {
    id: "vehicle-obd",
    ...
    image:
      "https://via.placeholder.com/600x400.png/ffc107/000000?text=Diagnostics",
  },
  {
    id: "air-conditioning",
    name: "Air-Conditioning",
    title: "Air Conditioning",
    description: "Stay cool with our A/C repair and maintenance services.",
    details: [
      "A/C performance check",
      "Refrigerant leak detection and repair",
      "A/C compressor and condenser repair/replacement",
      "Cabin air filter replacement",
    ],
    image: "https://via.placeholder.com/600x400.png/17a2b8/ffffff?text=Air-Con",
  },
  {
    id: "vehicle-up-keeping",
    name: "General Vehicle Up Keeping",
    title: "Vehicle Up Keeping",
    description:
    ...
    image:
      "https://via.placeholder.com/600x400.png/6f42c1/ffffff?text=Up-Keeping",
  },
  {
    id: "autobody-repair",
    ...
    image:
      "https://via.placeholder.com/600x400.png/dc3545/ffffff?text=Autobody",
  },
]
